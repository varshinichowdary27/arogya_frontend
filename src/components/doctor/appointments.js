...
export const Appointments = () => {
    ...
    React.useEffect(() => {
        ...
        getPatientList()
            ...
            .then(data => data.filter(patient => patient.rejected === false && patient.doctor_id != null 
                            ...
                            <TableHead>
                                <TableRow>
                                  <TableCell style={{ width: "94px" }}>
                                    ...
                                    <TableCell style={{ width: "16%" }} size='small' align="center">Delete Assesement</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
